...
public class RootContainerItemProvider 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcorePackage.Literals.ROOT_CONTAINER__CONTAINED_ELEMENTS,
				 EmployeemanagementFactory.eINSTANCE.createEmployee()));

		newChildDescriptors.add
			(createChildParameter
				(EcorePackage.Literals.ROOT_CONTAINER__CONTAINED_ELEMENTS,
				 EmployeemanagementFactory.eINSTANCE.createEmployeeManagementTests()));

		newChildDescriptors.add
			(createChildParameter
				(EcorePackage.Literals.ROOT_CONTAINER__CONTAINED_ELEMENTS,
				 EmployeemanagementFactory.eINSTANCE.createManager()));
	}
