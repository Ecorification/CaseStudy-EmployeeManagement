...
/**
 * This is the item provider adapter for a {@link ecore.edu.kit.ipd.sdq.employeemanagement.Employee} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EmployeemanagementPackage.Literals.EMPLOYEE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EmployeemanagementPackage.Literals.EMPLOYEE__SALARY,
				 true,
				 false,
				 false,
	...
	protected void addSupervisorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Employee_supervisor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Employee_supervisor_feature", "_UI_Employee_type"),
				 EmployeemanagementPackage.Literals.EMPLOYEE__SUPERVISOR,
				 true,
				 false,
				 true,
				 null,
